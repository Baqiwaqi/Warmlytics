      ...
      <>
         ...
         <main className="flex min-h-screen flex-col items-center justify-center bg-base-100">
            <div className="container card bg-base-100 w-96 flex flex-col p-8">
               ...
               <span className="text-md text-slate-600 font-semibold tracking-tight mt-4">Huidige Situatie</span>
         ...
         <div className="modal">
            <div className="modal-box p-8 justify-center content-center">
               <div className="flex justify-between">
                  <h3 className="font-bold text-lg">Huidige situatie</h3>
               ...
               <div className="flex justify-between mt-6">
                  <div className="flex flex-col space-y-2">
                     <span className="text-sm text-slate-500">Besparing gas</span>
               ...
               <div className="form-control w-full pt-6">
                  <label className="label py-1">
                     <span className="label-text text-slate-500">Emailadres</span>
                  </label>
                  <input
                     type="email"
